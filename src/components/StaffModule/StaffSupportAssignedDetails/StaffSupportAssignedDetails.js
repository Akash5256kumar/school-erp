          ...
          <View style={styles.FlatListView}>
            <View style={styles.CardView}>
              ...
              <View style={styles.BottomRowStyle}>
                ...
                <View>
                  <Text style={styles.TextRight}>{this.state.s_class}</Text>
                </View>
              </View>

              <View style={styles.BottomRowStyle}>
                <View>
                  <Text style={styles.TextLeft}>Admission No.</Text>
                </View>
                <View>
                  <Text style={styles.TextRight}>{this.state.admissionNo}</Text>
                </View>
              </View>
              ...
              <View style={styles.BottomRowStyle}>
                ...
                <View>
                  <Text style={styles.TextRight}>{this.state.feedback}</Text>
                </View>
              </View>
            </View>
          </View>
            ...
            <>
              <View style={styles.FlatListView}>
                <View style={styles.DeadlineCardView}>
                  ...
                  <View style={styles.deadlineCardRow}>
                    <View>
                      <Text style={styles.NormalText}>Deadline of query</Text>
                    </View>
                    <View>
                      <View>
                        <DatePicker
            ...
            <>
              <View style={styles.FlatListView}>
                <View style={styles.FeedbackCardView}>
                  ...
                  <View style={styles.deadlineCardRow}>
                    <View>
                      <Text style={styles.NormalText}>Response</Text>
                    </View>
