...
class StaffViewStudentAttendance extends Component {
    ...
    valueChangeHandler(object) {
        this.setState(object, () => {
            ...
            if ((date !== '') && (selectedClass !== 'Select Class') && (selectedSection !== 'Select Section')) {
            ...
            .then(async (responseJson) => {
                if (responseJson.status === true) {
                    ...
                    for (let i = 0; i < response.length; i++) {
                        let filteredArr = presentStudent.some(presentStudent => response[i].std_roll == presentStudent);
                    ...
                    renderItem={({ item, index }) =>
                        <View style={styles.FlatStyle}>
                            <View style={styles.CardviewStyle}>
                                ...
                                <Image style={styles.FlatlistImageStyle}
                                    source={item.image} />
                            </View>
                        </View>
                    }
