...
class StaffSupportSolvedDetails extends Component {
    ...
    async componentDidMount() {
        ...
        const myObject = await AsyncStorage.getItem('@MyItem:key');
        if (myObject !== null) {
            console.log('itemObject-->', JSON.parse(myObject));
            this.setState({
...
export default StaffSupportSolvedDetails;