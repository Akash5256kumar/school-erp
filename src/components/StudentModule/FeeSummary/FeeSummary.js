...
import { Text, View, FlatList, BackHandler, TouchableOpacity, Modal, PermissionsAndroid, Image } from 'react-native';
            ...
            .then((responseJson) => {
                if (responseJson.status === true) {
                    ...
                    var result = paidResponse.map(function (el, index) {
                        ...
                        startMonth = moment().month(paidResponse[index].startmonth - 1).format('MMMM');
                        endMonth = moment().month(paidResponse[index].endmonth - 1).format('MMMM');
                        if (index === 0) {
                            o.annualFee = response[0].admission_fees
                            o.totalFeeee = ((+response[0].tution_fees) + (+response[0].other_fees) + (+response[0].admission_fees))
            ...
            <View style={styles.MainContainer}>
                            ...
                            <View style={styles.CardView}>
                                ...
                                <View style={styles.CardViewStyle}>
                                    ...
                                    <View style={styles.DetailsContainer}>
                                        <View>
                                            <Text style={styles.TextLeft}>ORDERID- {item.orderID}</Text>
                                        </View>
                                    ...
                                    <View style={styles.RowStyle}>
                                        ...
                                        <View>
                                            <Text style={styles.TextRight}>{this.state.tutionFee}</Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={styles.RowStyle}>
                                        ...
                                        <View>
                                            <Text style={styles.TextRight}>{this.state.otherFee}</Text>
                                        </View>
                                    </View>
                                    ...
                                    <View
                                        style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', marginStart: 10, marginEnd: 10, height: 60 }}>
                                    ...
                                    <View style={styles.DownloadContainer}>
                                        <View style={styles.DetailBox}>
                                            <TouchableOpacity onPress={() => { this.openFile(item) }}>
                                                <Text style={styles.ContainerText}>Download Receipt</Text>
                                            </TouchableOpacity>
                                        </View>
                                    </View>
                ...
                <Modal
                    ...
                    <View style={styles.container}>
                        {/* {this.state.ext == "pdf" ? */}
                        <Pdf
                            source={{ uri: 'http://139.59.90.236/receiptfile/' + this.state.pdf }}
