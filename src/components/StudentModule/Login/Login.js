...
class Login extends Component {
    ...
    loginApi() {
        ...
        // return;
        const { dob, admissionNo, deviceVersion, deviceType, deviceName, token } = this.state;
        if (admissionNo == '') {
                ...
                <ScrollView keyboardShouldPersistTaps='always'>
                    <View style={styles.container}>
                        ...
                        <View style={styles.loginForm}>
                            ...
                            <TextInput placeholder='Type Admission Number'
                            placeholderTextColor={'#59597540'}
                                style={styles.TextInputStyleClass}
                                keyboardType='numeric'
                                secureTextEntry={this.state.ad_Visible}
                                // placeholderTextColor='#635d83'
                                onChangeText={this.changeAdmissionNumber}>
                            </TextInput>
                            <Pressable onPress={()=>this.setState({ad_Visible:!this.state.ad_Visible})}>
                            ...
                            <Text style={styles.staffLoginText}>If you are a Staff member than please{'\n'}click here to login</Text>
                            <TouchableOpacity style={styles.button}
