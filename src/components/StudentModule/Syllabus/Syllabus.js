...
import { Text, View, Image, FlatList, Modal, Alert,TouchableOpacity, PermissionsAndroid , BackHandler} from 'react-native';
                                ...
                                <View style={styles.CardViewStyle}>
                                    <View style={styles.DocImageAndTextStyle}>
                                        ...
                                        <View style={styles.TextViewStyle}>
                                            <Text style={styles.DashboardTextStyle}>{item?.subject}</Text>
                                    ...
                                    <TouchableOpacity onPress={() => {this.openFile(item)}
                                        ...
                                        <View>
                                            <Image style={styles.AssignmentDownloadImage} resizeMode='contain'
                ...
                <Modal
                    ...
                    <View style={styles.PdfHeaderBackground}>
                        <View style={styles.PdfHeaderStyle}>
                            ...
                            <TouchableOpacity onPress={() => this.historyDownload(this.state.pdf)}>
                                <Image style={styles.PdfHeaderArrowImage}
                                    source={constant.Icons.downloadIcon} />
                            </TouchableOpacity>
                        </View>
                    </View>
