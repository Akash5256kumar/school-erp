  ...
  return (
    <NavigationContainer>
      <Stack.Navigator
        ...
        <Stack.Screen name='ViewMoreSupportSystem' component={ViewMoreSupportSystem} />
        ...
        <Stack.Screen name='StaffIssueSubmission' component={StaffIssueSubmission} />
        <Stack.Screen name='StaffAttendance' component={StaffAttendance} />
        <Stack.Screen name='StaffSupportSystem' component={StaffSupportSystem} />
        <Stack.Screen name='StaffViewRequest' component={StaffViewRequest} />
        <Stack.Screen name='StaffAddAttendance' component={StaffAddAttendance} />
        <Stack.Screen name='StaffViewStudentAttendance' component={StaffViewStudentAttendance} />
        <Stack.Screen name='StaffViewItemQuery' component={StaffViewItemQuery} />
        <Stack.Screen name='StaffViewItemQueryDetails' component={StaffViewItemQueryDetails} />
        <Stack.Screen name='StaffLeaveDetail' component={StaffLeaveDetail} />
        <Stack.Screen name='StaffSupportSolvedDetails' component={StaffSupportSolvedDetails} />
        <Stack.Screen name='StaffSupportAssignedDetails' component={StaffSupportAssignedDetails} />
        <Stack.Screen name='StaffSupportUnSolvedDetails' component={StaffSupportUnSolvedDetails} />
      </Stack.Navigator>
    </NavigationContainer>
  )
};
